                            ...
                            <div class="card-body">
                                        ...
                                        <table class="table align-middle table-nowrap mb-0" id="customerTable">
                                            <thead class="table-light">
                                                <tr>
                                                    ...
                                                    <th class="sort" data-sort="owner" scope="col">العنوان</th>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="flex-grow-1 ms-2 name">
                                                                    <a href="{{ route('admin.order_user',$user->id) }}">{{ $user->name }}</a>
                                                                    </div>
                                                            </div>
                                                        </td>


                                                        <td class="owner">{{ $user->address }}</td>
                                                        ...
                                                        <td>
                                                            <ul class="list-inline hstack gap-2 mb-0">
                                                                ...
                                                                <li
                                                                    ...
                                                                    <a href="{{ route('admin.clients.edit',$user->id) }}"><i class="ri-pencil-fill fs-16"></i></a>
                                                                </li>
                                                                {{-- <li
                                                                    title="Edit">
                                                                ...
                                                                <li class="list-inline-item text-danger" data-bs-toggle="tooltip"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body p-5 text-center">
                                                                    ...
                                                                    <form
                                                                        action="{{ route('admin.clients.destroy', $user->id) }}"
                                                                        method="post">
                                                                        @method('delete')
                                                                        @csrf
                                                        ...
                                                        <div class="modal-dialog ">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body ">
                                                                    <form class="{{ route('admin.clientsupdate',$user->id) }}" method="post" autocomplete="off">
                                                                        @csrf
                                                                            <div class="modal-body">
                                                                    ...
                                                                    {{-- <form
                                                                        class="{{ route('admin.clients.update', $user->id) }}"
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content border-0">
                                        ...
                                        <form class="{{ route('admin.clients.store') }}" method="post" autocomplete="off">
                                            @csrf
                                            <div class="modal-body">
                                                <input type="hidden" id="id-field">
                                                <div class="row g-3">
                                                            ...
                                                            <div class="position-relative d-inline-block">
                                                                ...
                                                                <div class="avatar-lg p-1">
                                                                    <div class="avatar-title bg-light rounded-circle">
                                                                        <img src="{{ asset('assets/logo/1-02.png') }}"
                                                                            id="companylogo-img"

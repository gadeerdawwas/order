                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body p-5 text-center">
                                                                    ...
                                                                    <form
                                                                        action="{{ route('admin.profits.destroy', $cost->id) }}"
                                                                        method="post">
                                                                        @method('delete')
                                                                        @csrf
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body p-5 text-center">
                                                                    ...
                                                                    <form
                                                                        action="{{ route('admin.profits.update', $cost->id) }}"
                                                                        method="post">
                                                                        @method('put')
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="flex-grow-1 ms-2 owner">
                                                                <a href="{{ route('admin.printprofit',$id) }}" class="btn btn-success"><i class="ri-printer-line align-bottom me-1"></i> Print</a>
